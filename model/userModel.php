<?php
    ...
    class userModel extends mainModel{
        ...
        protected function add_user_model($data){
            ...
            $sql->bindParam(":Equipo",$data['Equipo']);
        ...
        protected function update_user_model($data){
            $sql=mainModel::conectar()->prepare("UPDATE usuario SET usuario_nombre=:Nombre,usuario_apellido=:Apellido,usuario_email=:Email,usuario_telefono=:Telefono,usuario_rol=:Rol,usuario_equipo=:Equipo,usuario_username=:Username,usuario_password=:Password,usuario_estatus=:Estatus WHERE usuario_id=:ID");
